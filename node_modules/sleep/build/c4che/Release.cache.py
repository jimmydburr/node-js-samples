...
CPPPATH_NODE = '/usr/local/Cellar/node/0.8.20/include/node'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g']
...
LIBDIR = '/Users/jburrell/.node_libraries'
LIBPATH_NODE = '/usr/local/Cellar/node/0.8.20/lib'
LIBPATH_ST = '-L%s'
LIB_ST = '-l%s'
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/Users/jburrell/.node_libraries'
PREFIX = '/usr/local'
PREFIX_NODE = '/usr/local/Cellar/node/0.8.20'
